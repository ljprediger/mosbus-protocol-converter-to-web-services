...
/*Definición de prioridad y stack de tarea que se escarga del stack tcpip*/
#define configLWIP_TASK_PRIORITY					( 1U )
#define conifgTCPIP_TASK_STACK_SIZE					( configMINIMAL_STACK_SIZE * 3 )
